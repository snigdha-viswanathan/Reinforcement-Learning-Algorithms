# -*- coding: utf-8 -*-
"""Actor Critic Corrected - Cartpole.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1GuDnzK91ArsKLTF3FndrBttLfTA9TcMj
"""
...
plt.xlabel('episodes')
plt.title('Cartpole - One Step Actor Critic')
plt.show()
...
s = env.reset()
env = gym.wrappers.RecordVideo(env, '/content/drive/MyDrive/RL/Actor_Critic/', name_prefix="CartPole")
done = False
r = 0
while not done:
  action_probs = get_action_probs(s, policy_network)
